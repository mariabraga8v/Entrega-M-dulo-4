		...
		<div class="row">
			<div class="cold-md-7">
				...
				<form action= "ProdutoUpdate" method="POST">
						...
						<input  value="${produto.id}" name ="id" maxlength="40" type="text" class="form-control" readonly="readonly" >
						<label>ID</label>
						</div>
						<div class="form-floating mb-3">
							<input value="${produto.descricao}" name="descricao" maxlength="40" type="text" class="form-control" id="floatingInput1"> 
							<label>Descrição do pacote</label>
						</div>
						<div class="form-floating mb-3">
							<input value="${produto.valor}" name="valor" maxlength="11" type="text" class="form-control"> 
							<label>Valor (use ponto '.' na casa decimal)</label>
						</div>
