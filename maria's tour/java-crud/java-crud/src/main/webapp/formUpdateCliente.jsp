		...
		<div class="row">
			<div class="cold-md-7">
				...
				<form action= "ClienteUpdate" method="POST">
						...
						<input  value="${cliente.id}" name ="id" maxlength="40" type="text" class="form-control" readonly="readonly" >
						<label>ID</label>
						</div>
						<div class="form-floating mb-3">
						...
						<button class="btn btn-warning" type="reset">Limpar Formulário</button>
				</form>
				<br>
			</div>
		</div>
